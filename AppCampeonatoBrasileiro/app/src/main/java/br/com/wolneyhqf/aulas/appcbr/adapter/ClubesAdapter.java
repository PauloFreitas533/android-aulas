package br.com.wolneyhqf.aulas.appcbr.adapter;
...
public class ClubesAdapter extends RecyclerView.Adapter<ClubesAdapter.ClubesViewHolder> {
    ...
    public void onBindViewHolder(final ClubesViewHolder holder, final int position) {
        ...
        holder.textViewLocalizacao.setText(clube.getCidade() + " - " + clube.getEstado());
        holder.textViewEstadio.setText(clube.getEstadio());

        Picasso.with(context).load(clube.getUrlEscudo())
                .placeholder(R.drawable.escudo)
                .error(R.drawable.escudo)
                .into(holder.imageViewEscudo);
    ...
    public static class ClubesViewHolder extends RecyclerView.ViewHolder{
        ...
        public ClubesViewHolder(View view){
            ...
            textViewEstadio = (TextView) view.findViewById(R.id.text_estadio);
            textViewLocalizacao = (TextView) view.findViewById(R.id.text_localizacao);
            imageViewEscudo = (ImageView) view.findViewById(R.id.image_escudo);
        }
